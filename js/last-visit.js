...
const date = `Ostatni raz byłeś u nas ${addZero(showDate.getDate())}-${addZero(showDate.getMonth() + 1)}-${showDate.getFullYear()}r., o godzinie ${addZero(showDate.getHours())}:${addZero(showDate.getMinutes())}:${addZero(showDate.getSeconds())}.`;
